 ...
 * @Description DocMind 本地 SQLite 收藏、集合与关联项存储实现。
 */
use uuid::Uuid;

use crate::docmind::models::{CollectionItemView, CollectionView, FavoriteView};
use crate::docmind::storage::types::{CollectionItemInput, CollectionPatchInput};
