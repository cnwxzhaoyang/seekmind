...
mod macos_quicklook {
    ...
    define_class!(
        ...
        #[name = "DocMindQuickLookPreviewView"]
        #[thread_kind = MainThreadOnly]
        struct DocMindQuickLookPreviewView;

        unsafe impl NSObjectProtocol for DocMindQuickLookPreviewView {}

        impl DocMindQuickLookPreviewView {
    ...
    struct QuickLookPanelState {
        ...
        preview_view: Retained<DocMindQuickLookPreviewView>,
    ...
    unsafe fn create_panel_state(mtm: MainThreadMarker) -> QuickLookPanelState {
        ...
        let preview_view = DocMindQuickLookPreviewView::new(mtm, frame);
